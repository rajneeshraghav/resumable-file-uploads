...
declare module Resumable {
  ...
  export class Resumable {
     ...
     **/
    appendFilesFromFileList(files, Event): void;
     ...
     **/
    on(event: 'AuthError', callback: (file: ResumableFile, message: string) => void): void;

    on(event: 'chunkFinished', callback: (file: ResumableFile, message: string) => void): void;

    on(event: 'ChunkComplete', callback: (file: ResumableFile) => void): void;
