  ...
  var Resumable = function (opts) {
    ...
    var $h = {
      ...
      generateUniqueIdentifier: function (file, event) {
        ...
        var size = file.size;
        return (file.lastModified + '-' + relativePath.replace(/[^0-9a-zA-Z_-]/img, ''));
      },
    ...
    function ResumableChunk(resumableObj, fileObj, offset, callback) {
      ...
      $.test = function () {
        ...
        params = params.concat(
          [
            ...
            ['identifierParameterName', `${Date.now() + $.fileObj.fileName}.`],
      ...
      $.send = function () {
        ...
        var query = [
          ...
          ['totalSizeParameterName', $.fileObjSize],
          ['typeParameterName', $.fileObjType],
          ['identifierParameterName', $.getIdent($.fileObj)],
          ['fileNameParameterName', $.fileObj.fileName],
          ['relativePathParameterName', $.fileObj.relativePath],
          ['totalChunksParameterName', $.fileObj.chunks.length],
        ].filter(function (pair) {
      ...
      $.status = function () {
        ...
        if ($.pendingRetry) {
          ...
          if ($.xhr.status == 200 || $.xhr.status == 201) {
            ...
            $.resumableObj.fire('chunkFinished')
            return ('success');
          }

          else if ($.xhr.status == 401) {
            $.resumableObj.fire('AuthError')
            return ('uploading');
          }
